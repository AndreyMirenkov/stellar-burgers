...
export const GET_DATA_ABOUT_PROFILE: 'GET_DATA_ABOUT_PROFILE' = 'GET_DATA_ABOUT_PROFILE';
...
export const RESET_SUCCESS_INPUT_NEW_PASSWORD: 'RESET_SUCCESS_INPUT_NEW_PASSWORD' = 'RESET_SUCCESS_INPUT_NEW_PASSWORD'