...
export const WS_AUTH_WATCH_ORDER: 'WS_AUTH_WATCH_ORDER' = 'WS_AUTH_WATCH_ORDER';
export const WS_AUTH_DELETE_WATCH_ORDER: 'WS_AUTH_DELETE_WATCH_ORDER' = 'WS_AUTH_DELETE_WATCH_ORDER';